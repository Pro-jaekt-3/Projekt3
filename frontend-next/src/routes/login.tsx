          ...
          <form className="mt-6 space-y-3" onSubmit={handleEmailLogin}>
            ...
            >
              <svg className="mr-2 h-4 w-4" viewBox="0 0 48 48" aria-hidden>
                ...
                <path fill="#4CAF50" d="M24 43.5c5 0 9.5-1.9 12.9-5l-5.9-5c-2 1.5-4.4 2.4-7 2.4-5.3 0-9.7-3.4-11.3-8.1l-6.5 5C9.6 39 16.2 43.5 24 43.5z"/>
                <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.1-4 5.5l5.9 5C40.6 35 43.5 30 43.5 24c0-1.2-.1-2.4 0.1-3.5z"/>
              </svg>
              Sign in with Google
            </Button>
